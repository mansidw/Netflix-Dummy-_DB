...
if (isset($_POST['reg_user'])) {
  ...
  {
    $cid=uniqid(rand());
    $query = "INSERT INTO sitelog(c_id,username,password,email_id) VALUES ('$cid','$username','$password_1','$emailid')";
    mysqli_query($db, $query);
    $_SESSION['username'] = $username;
    header('location: Ainfodish.php');
  }
}
?>
...
<div class="mainone">
  ...
  <div class="col-md-9">
      <form method="post" action="">
          ...
          <p>
            Already a member? <a href="Alogin.php" class="newanchor">Login</a>
          </p>
        </form>
  </div>
</div>
