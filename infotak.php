...
if (isset($_POST['checkout']))
{
  ...
  $user_check_query = "SELECT * FROM customer WHERE email_id='$email' LIMIT 1;";
  ...
  if (count($errors) == 0) 
  {
    $query = "INSERT INTO `customer`('customer_id','first_name','last_name','email_id','phone_no','country','state','DOB') VALUES ('16','$firstname','$lastname','$email','$phoneno','$country','$state','$dob')";
